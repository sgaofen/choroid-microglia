...
OUT = ROOT / 'experiments/v30d_compact_gate'
...
def run_image(stem):
    ...
    (OUT / f'{stem}_seeds_v30d.json').write_text(json.dumps(safe_seeds, indent=1))
    (OUT / f'{stem}_endpoint_counts_v30d.json').write_text(
