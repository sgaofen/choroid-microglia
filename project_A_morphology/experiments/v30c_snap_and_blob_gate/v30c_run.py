...
OUT = ROOT / 'experiments/v30c_snap_and_blob_gate'
...
def run_image(stem):
    ...
    (OUT / f'{stem}_seeds_v30c.json').write_text(json.dumps(safe_seeds, indent=1))
    (OUT / f'{stem}_endpoint_counts_v30c.json').write_text(
